...
public class DBAPI {
    ...
    public List<Book> getBooks() {
        ...
        try {
            ...
            while (rs.next()) {
                Book temp = new Book(rs.getInt(1), rs.getString(2), rs.getBoolean(3), rs.getString(4), rs.getBoolean(5));
    ...
    public List<Dvd> getDvd() {
        ...
        try {
            ...
            while (rs.next()) {
                Dvd temp = new Dvd(rs.getInt(1), rs.getString(2), rs.getString(3));
                dvdList.add(temp);
            }
            con.close();
        } catch (Exception e) {
    ...
    public List<Magazine> getMagazine() {
        ...
        try {
            ...
            while (rs.next()) {
                Magazine temp = new Magazine(rs.getInt(1), rs.getString(2), rs.getString(3));
    ...
    public List<DeskClerk> getDeskClerk() {
        ...
        try {
            ...
            while (rs.next()) {
                DeskClerk temp = new DeskClerk(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getDouble(6), rs.getInt(7));
    ...
    public List<Librarian> getLibrarian() {
        ...
        try {
            ...
            while (rs.next()) {
                Librarian temp = new Librarian(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getDouble(6), rs.getInt(7));
    ...
    public List<Borrower> getBorrower() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("select * from Librarian");
            while (rs.next()) {
                Borrower temp = new Borrower(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5));
                librarianList.add(temp);
            }
            con.close();
        } catch (Exception e) {
